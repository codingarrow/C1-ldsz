<div class="span9">
    <div class="row-fluid">
        ...
        <p>
            <?php echo anchor('admin/archives/printer', '<i class="icon-print icon-white"></i> Print', array('class' => 'btn btn-primary', 'target' => '_blank')); ?>
            <?php echo anchor('admin/archives/export', '<i class="icon-print icon-white"></i> Export', array('class' => 'btn btn-primary', 'target' => '_blank')); ?>
        </p>
