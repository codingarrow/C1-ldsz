	 ...
	 <div class="midrc">
		<div class="midrca3">
			...
			<p style="padding-bottom: 10px;">
				...
				<?php echo anchor('admin/leads/index', '<input type="button" value="Add New Lead" style="text-decoration: none;">'); ?>
				<?php echo anchor('admin/leads/export', '<input type="button" value="Export to Excel" style="text-decoration: none;">'); ?>
				<?php echo anchor('admin/leads/exportedToCSV', '<input type="button" value="Export to CSV" style="text-decoration: none;">'); ?>
				<?php //echo anchor('admin/leads/importDB', '<input type="button" value="Import Data from Excel" style="text-decoration: none;">'); ?>
			</p>
			<p style="padding-bottom: 10px;" class="t4">
				No. of leads: <strong><?php echo $count; ?></strong><br>
			</p>
