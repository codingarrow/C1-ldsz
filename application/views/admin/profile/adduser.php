...
<div class="main">
 ...
 <div class="midi">
    ...
    <div class="midmrh">
		...
		<div class="midmrtitle t3">Add User <?php //echo ucfirst($user->last_name); ?><!--,&nbsp;--><?php //echo ucfirst($user->first_name); ?></div>
				...
				<div class="midmrc">
				  <div class="midrca t4">
					...
					<?php echo form_open('admin/profile/adduser'); ?>
					<div class="cul t5">
						<strong>First Name</strong><br>
						<input type="text" name="first_name" value="<?php echo set_value('first_name'); ?>" class="f3 t5c" tabindex="1"><br>
						<strong>Email</strong><br>
						<input type="text" name="email" value="<?php echo set_value('email'); ?>" class="f3 t5c" tabindex="3"><br>  
						<strong>Username</strong><br>
						<input type="text" name="username" value="<?php echo set_value('username'); ?>" class="f3 t5c" tabindex="5"><br>
						<strong>Password</strong><br>
						<input type="password" name="password" class="f3 t5c" tabindex="6"><br>
						<strong>Retype New Password</strong><br>
						<input type="password" name="retype_password" class="f3 t5c" tabindex="7"><br>
					</div>
					...
					<div class="cur2">
					  <div class="cura2">
						<div class="curb">
							...
							<input type="text" name="last_name" value="<?php echo set_value('last_name'); ?>" class="f3 t5c" tabindex="2"><br>
							<strong>User Type</strong><br>
							<select name="user_type" class="f3 t5c" tabindex="4">
								<option value="1" <?php echo set_select('user_type', '1'); ?>>Administrator</option>
								<option value="1" <?php echo set_select('user_type', '3'); ?>>Verifier</option>
							</select><br>
